...
void ColorShader::Render(int indexCount, DirectX::XMMATRIX world)
{
	SetShaderParameters(world);
	RenderShader(indexCount);
}

void ColorShader::SetShaderParameters(DirectX::XMMATRIX worldMatrix)
{
